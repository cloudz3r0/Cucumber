...
public class APIWorkflowSteps {
    ...
    public void the_status_code_for_this_request_is(Integer statusCode) {
        ...
        response.then().assertThat().
                body("Employee.emp_firstname",equalTo("Adrian"));
        response.then().assertThat().
...
//------------------------------------------------------------------------------
    ...
    public void a_request_is_prepared_to_retrieve_all_employees() {
        request = given().
                header(APIConstants.Header_Content_Type_Key,APIConstants.Content_type_Value)
                .header(APIConstants.Header_Authorization_key,token).body(APIPayloadConstants.createEmployeePayload());
        response=request.when().get(APIConstants.GET_ALL_EMPLOYEE_URI);
        response.prettyPrint();

    }
    @Given("a request is made to retrieve all jobtitles")
    public void a_request_is_made_to_retrieve_all_jobtitles() {
        request = given().
                header(APIConstants.Header_Content_Type_Key,APIConstants.Content_type_Value)
                .header(APIConstants.Header_Authorization_key,token);
        response=request.when().get(APIConstants.GET_ALL_JOBTITLES);
        response.prettyPrint();
    }
    ...
    public void theStatusCodeForUpdatingTheEmployeeIs(Integer statusCode) {
        response.then().assertThat().statusCode(statusCode);
    }
}
